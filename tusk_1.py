...
# с декоратором @classmethod, должен извлекать число, месяц, год и преобразовывать
...
today = Data('5 - 1 - 2021')
print(today)
print(Data.valid(11, 11, 2100))
print(today.valid(11, 15, 2020))
print(Data.extract('5 - 1 - 2021'))
print(today.extract('12 - 1 - 2020'))
print(Data.valid(2, 12, 2020))
